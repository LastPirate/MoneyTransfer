...
public class TransferRecord extends UpdatableRecordImpl<TransferRecord> implements Record7<Long, BigDecimal, LocalDateTime, Double, String, Long, Long> {

    private static final long serialVersionUID = -436807533;
    ...
    @Override
    public Row7<Long, BigDecimal, LocalDateTime, Double, String, Long, Long> valuesRow() {
    ...
    @Override
    public TransferRecord values(Long value1, BigDecimal value2, LocalDateTime value3, Double value4, String value5, Long value6, Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TransferRecord(Long id, BigDecimal quantity, LocalDateTime moment, Double exchangeRate, String description, Long senderId, Long recipientId) {
        super(Transfer.TRANSFER);

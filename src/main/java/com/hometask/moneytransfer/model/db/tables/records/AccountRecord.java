...
public class AccountRecord extends UpdatableRecordImpl<AccountRecord> implements Record3<Long, String, BigDecimal> {
    ...
    private static final long serialVersionUID = -1153433;
    ...
    @Override
    public AccountRecord values(Long value1, String value2, BigDecimal value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public AccountRecord(Long id, String name, BigDecimal balance) {
        super(Account.ACCOUNT);
